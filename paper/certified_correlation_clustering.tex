...
\SI{600}{s}) and, not significantly, on \texttt{com-Youtube} and, at short budgets of \SI{60}{s}--\SI{150}{s}, on the largest
graphs (by $0.1\%$--$0.7\%$), where our initial population takes too much of
the budget.  PXMem also needs up to twice the memory of KaPoCE.
