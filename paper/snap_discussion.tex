...
this section.  On the eleven graphs whose support fits into memory, the
CertiFlip bound certifies the best known solutions within $0.2\%$ to $9.2\%$
of optimal.  The median gap is about $6\%$, and on the collaboration networks
...
this size.  The bounds for \texttt{com-Amazon} and \texttt{com-DBLP}
($3\cdot10^5$ vertices, $10^6$ edges) were computed in under five minutes on
one core.  The dense-matrix implementation of the KaPoCE packing bounds cannot
