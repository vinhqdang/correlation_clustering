...
$x$-form read $\sum_t x_{vt}-\sum_{tt'}x_{tt'}\ge (k-1)-\binom k2$.  A
direct computation shows that $\LB(y)$ then equals the packing value
$\sum(k-1)$, because every pair covered by a star gets reduced cost $0$.
