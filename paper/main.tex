...
instances.  On fifteen SNAP graphs with up to $1.1\cdot 10^6$ vertices, it
certifies the best known solutions within $0.2\%$ to $9.2\%$ of optimal.
Previously scalable bounds certified factors of $1.17$ to $1.81$ on the same
graphs.
\end{enumerate}
...
best engineered heuristic in a fraction of its running time.

\paragraph{Limitations.}
\begin{itemize}
\item The best primal solutions on our benchmarks still come from KaPoCE,
which is $0.1\%$--$0.4\%$ better than CertiFlip on the SNAP graphs.
