...
Table~\ref{tab:h2h} (ten seeds per graph and budget; one \SI{150}{s} run on
\texttt{com-Youtube} is missing).  Median paired relative difference
...
overall (PXMem wins 43 and 41 runs and loses 84 and 70; sign test $p<0.01$
...
behind at \SI{60}{s} and $0.18\%$ at \SI{150}{s}.  On \texttt{ca-HepTh}
