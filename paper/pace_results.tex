...
\begin{figure}[!tbp]
\centering
\includegraphics[width=0.6\textwidth]{figures/fig_pacebounds.pdf}
\caption{PACE~2021 exact track, 173 instances with known optimum: lower bound
divided by the optimum against edge density, for the checked CertiFlip bound
and the root star-packing bound of the KaPoCE branch-and-bound.}
\label{fig:pacebounds}
\end{figure}

\paragraph{Lower bounds.}  Table~\ref{tab:pace-bounds} and
Figure~\ref{fig:pacebounds} compare the bounds.
All CertiFlip bounds in this subsection are the values returned by the
