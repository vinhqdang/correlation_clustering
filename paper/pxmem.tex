...
following lemma is due to \citet{Guo09kernel}; we include the short proof
because the implementation relies on its exact form.
...
this way is standard in cluster editing~\citep{Guo09kernel}.  On the collaboration graphs the
...
the partition crossover of \citet{WhitleyHH09gpx} for tours; the argument is a
few lines, and we claim no novelty for it.  It combines \emph{any} two
...
clusterers~\citep{hausberger2025scc}.  The flipping round of line~3 costs a few
